...
public class NewCycleAutonomous extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence preLoad = drive.trajectorySequenceBuilder(startPose)
                ...
                .lineToLinearHeading(Constants.Path.PreLoad.lineToLinearHeading, vel, accel) // The lower the right number is, the more the bot will go right. Higher = more straight of a path
