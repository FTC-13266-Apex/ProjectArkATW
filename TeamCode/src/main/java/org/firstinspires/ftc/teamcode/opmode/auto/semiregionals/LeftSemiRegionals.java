...
public class LeftSemiRegionals extends RoadRunnerAuto {
    public static class Constants {
        ...
        public static class Path {
            ...
            public static Forward preload1 = new Forward(8);
            public static LineToLinearHeading preload2 = new LineToLinearHeading(-36, -24, 180);
            static TrajectorySequenceContainer preload = new TrajectorySequenceContainer(preload1, preload2);
            ...
            public static SplineToConstantHeading cycle1Pickup2 = new SplineToConstantHeading(-46, -11, 180);
