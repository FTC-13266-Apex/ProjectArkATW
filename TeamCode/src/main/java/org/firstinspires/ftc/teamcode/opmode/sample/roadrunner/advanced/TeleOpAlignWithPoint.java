...
public class TeleOpAlignWithPoint extends LinearOpMode {
    ...
    private PIDFController headingController = new PIDFController(Drive.Constants.Follower.HEADING_PID);
            ...
            switch (currentMode) {
                ...
                case ALIGN_TO_POINT:
                    ...
                    double headingInput = (headingController.update(poseEstimate.getHeading())
                            * Drive.Constants.Controller.kV + thetaFF)
                            * Drive.Constants.Drivetrain.TRACK_WIDTH;
